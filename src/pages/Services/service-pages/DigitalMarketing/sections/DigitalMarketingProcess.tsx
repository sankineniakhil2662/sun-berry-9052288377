...
import type { DigitalMarketingProcessData } from "../digitalmarketing.data";

export default function DigitalMarketingProcess({ data }: { data: DigitalMarketingProcessData }) {
  return (
