...
import type { InternshipOverviewData } from "../InternshipPrograms.data";

export default function InternshipOverview({ data }: { data: InternshipOverviewData }) {
  return (
      ...
      <div className="mx-auto grid w-full max-w-7xl gap-12 px-6 lg:grid-cols-2 lg:gap-16 lg:px-10">
        ...
        <ScrollReveal direction="left" delay={0.15}>
          <div className="relative h-full rounded-3xl border border-border bg-surface p-8 shadow-card">
            ...
            />
            <h3 className="relative text-lg font-semibold text-heading">Program highlights</h3>
