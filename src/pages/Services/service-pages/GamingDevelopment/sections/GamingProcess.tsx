...
import type { GamingProcessData } from "../gamingdevelopment.data";

export default function GamingProcess({ data }: { data: GamingProcessData }) {
  return (
            ...
            <ScrollReveal key={step.no} delay={idx * 0.05}>
              <div className="relative h-full rounded-2xl border border-border bg-surface p-6 shadow-card transition hover:-translate-y-0.5 hover:shadow-hover">
                <div className="flex items-center gap-4">
                  ...
                  <div className="h-px flex-1 bg-gradient-to-r from-[rgb(var(--color-accent-cyan))]/30 to-transparent" />
                </div>
